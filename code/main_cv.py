...
servo = create_servo(channel=0, max_pulse=2500, min_pulse=500, reverse_angle=True,center_fix = 6, max_angle=35)
...
def main():
    ...
    run_speed = 0.4
    offset_fix_factor = 0 # to compensate quircky track , rais above 0 if bad ccw and lower for bad cw
    max_offset = 40
    try:
        while True:
            curr_time = time.time()
