...
class ServoController:
    def __init__(self, channel=0, min_pulse=1000, max_pulse=2000, reverse_angle = False,center_fix = 6, max_angle = 90):
...
def create_servo(channel=0, min_pulse=1000, max_pulse=2000, reverse_angle= False,center_fix = 6, max_angle = 90):
    """Create and return a ServoController instance."""
    return ServoController(channel, min_pulse, max_pulse, reverse_angle,center_fix, max_angle)